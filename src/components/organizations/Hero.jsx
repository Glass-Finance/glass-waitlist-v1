...
// serving an unoptimized file while MembersHero.jsx (a Vite-imported
// asset) got build-time optimization. Both heroes now go through the same
// cldUrl() helper and the same public_id, so they can't diverge again.
