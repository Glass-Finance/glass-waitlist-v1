    ...
    >
      ...
      <div className="max-w-[1140px] mx-auto px-6 relative z-30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {features.map(({ icon, title, desc, illustration, imgTransform }, i) => (
            <div
              key={title}
              {...anim(3 + i, 200 + i * 80)}
            ...
            >
              ...
              <div
                ...
                style={{
                  padding: "clamp(16px, 3vw, 28px) clamp(14px, 2.5vw, 20px) clamp(12px, 2vw, 20px)",
                }}
              >
                <img
                  src={icon}
              ...
              >
                ...
                <img
                  ...
                  style={{
                    ...
                    top: "50%",
                    left: "50%",
                    transform: imgTransform || "translate(-50%, -45%) scale(1.15)",
                    width: "100%",
                    height: "85%",
                    objectFit: "contain",
